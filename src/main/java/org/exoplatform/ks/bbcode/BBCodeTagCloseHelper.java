...
public class BBCodeTagCloseHelper {
  ...
  /*
   * - Starting a tag is always legal (can all tags be nested?) - Closing a tag
   * - If tag specified matches most recently opened tag, close it. - Elseif
   * most recently started tag != tag specified - If tag specified is in the tag
   * close ignore list, remove from tag close ignore list - Elseif tag specified
   * was opened at some point, just not most recently: - Close all tags in the
   * stack up to and including the specified tag - For all tags that were closed
   * other than the specified tag, add to tag close ignore list - Elseif tag
   * specified was never opened, execute badTag(....) - Consider reopening some
   * tags?
   */
